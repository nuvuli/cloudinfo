...
func (e *Ec2Infoer) GetServiceImages(service, region string) ([]types.Image, error) {
	...
	switch service {
	case svcEks:
		for _, k8sVersion := range []string{"1.13", "1.14", "1.15", "1.16"} {
...
func (e *Ec2Infoer) GetVersions(service, region string) ([]types.LocationVersion, error) {
	switch service {
	case svcEks:
		return []types.LocationVersion{types.NewLocationVersion(region, []string{"1.13.12", "1.14.9", "1.15.10", "1.16.8"}, "1.16.8")}, nil
	default:
